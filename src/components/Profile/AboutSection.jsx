    ...
    <Row className="py-4">
      ...
      <Col md={12} lg={4}>
        <div className="card p-4 mt-4 mt-lg-0">
          ...
          <div className="mb-3">
            <Badge className="badge-skill">UI Design</Badge>
            <Badge className="badge-skill">UX Research</Badge>
            <Badge className="badge-skill">Figma</Badge>
            <Badge className="badge-skill">Design Systems</Badge>
            <Badge className="badge-skill">Prototyping</Badge>
          </div>
