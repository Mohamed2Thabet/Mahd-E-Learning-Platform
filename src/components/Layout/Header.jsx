      ...
      <Container>
        ...
        <Navbar.Collapse id="navbarScroll">
          ...
          <Form className="d-flex gap-4">
            <NavLink to="/login">
        <Button variant="success" className="text-uppercase fw-semibold rounded-5 py-2 px-4">
          Log in
        </Button>
      </NavLink>

      <NavLink to="/signin" className="ms-2"> 
        <Button variant="outline-success" className="text-uppercase fw-semibold rounded-5 py-2 px-4">
          Sign in
        </Button>
      </NavLink>
          </Form>
